...
class Login extends React.Component {
  ...
  handleLogin(event) {
	...
	var destination = this.props.location.query.destinationPath;
	var destination = (typeof destination === 'undefined') ? '/' : destination;
	this.props.dispatch(login(this.state.email, this.state.password, destination));
  }
